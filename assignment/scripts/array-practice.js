...
let favoriteFoods = ['steak', 'pasta', 'berries', 'poptarts']
...
let lastAnimal = animalArray[animalArray.indexOf( 'dog' )]
...
let dessert = 'apple pie';
favoriteFoods.push(dessert);
console.log('apple pie dessert to end',favoriteFoods);
